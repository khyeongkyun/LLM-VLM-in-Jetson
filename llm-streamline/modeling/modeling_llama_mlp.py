...
# ─────────────────────────────────────────────────────────────────────────────
# Constants – set both values before running train.py.
# ─────────────────────────────────────────────────────────────────────────────

# 0-indexed position of the layer whose output is fed into replace_layer
# and whose weights initialise it.  Layers 0..BEST_LAYER are frozen;
    ...
    def forward(
        ...
        for decoder_layer in self.layers:
            ...
            if idx == self.start_pruned_layer - 1:
                replace_hidden_states = self.replace_layer(hidden_states)
            idx += 1
        ...
        return BaseModelOutputWithPast(
            last_hidden_state=[hidden_states, replace_hidden_states],
